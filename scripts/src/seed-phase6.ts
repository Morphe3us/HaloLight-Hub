...
export async function seedPhase6(seedClientIds?: string[]) {
  console.log("\nSeeding Phase 6 — Equipment & Consumables...");

  // ─── Consumable Catalog ────────────────────────────────────────────────────
  const existingCatalog = await db
    .select({ id: consumableCatalog.id })
    .from(consumableCatalog)
    .limit(1);
    ...
    await db.insert(consumableCatalog).values([
      {
        ...
        category: "paper",
        description:
          "400-sheet pack of premium 4×6 glossy photo paper. Suitable for all HaloLight printers.",
        unitType: "packs",
        unitPrice: "49.99",
        reorderThreshold: 3,
        compatibleModels:
          "HaloLight Pro 2, HaloLight Elite, HaloLight Open Air",
      },
      {
        ...
        category: "paper",
        description:
          "400-sheet pack of premium 4×6 matte photo paper for a sophisticated finish.",
        unitType: "packs",
        unitPrice: "52.99",
        reorderThreshold: 3,
        compatibleModels:
      ...
      },
      {
        ...
        category: "paper",
        description:
          "800-strip pack of 2×6 glossy strip paper. Perfect for classic booth experiences.",
        unitType: "packs",
        unitPrice: "44.99",
        reorderThreshold: 4,
      ...
      },
      {
        ...
        category: "ribbon",
        description:
          "DNP DS40 YMCO ribbon cartridge. Yields ~400 4×6 prints per roll.",
        unitType: "rolls",
        unitPrice: "34.99",
        reorderThreshold: 2,
      ...
      },
      {
        ...
        category: "cleaning",
        description:
          "Universal printer cleaning kit with cleaning cards, swabs, and solution.",
        unitType: "kits",
        unitPrice: "19.99",
        reorderThreshold: 1,
      ...
      },
      {
        ...
        category: "accessory",
        description:
          "80-piece standard props assortment. Hats, glasses, signs, and novelty items.",
        unitType: "boxes",
        unitPrice: "39.99",
        reorderThreshold: 1,
        compatibleModels: "All models",
  ...
  if (existingEquipment.length > 0) {
      ...
      equipmentData.push(
        {
          ...
          maintenanceNotes:
            "Printer head cleaned. All sensors calibrated. Operating at peak performance.",
        },
        {
          userId: sarah.id,
    ...
    if (marcus) {
      equipmentData.push({
        ...
        maintenanceNotes:
          "Minor scuff on exterior. Printer operational. Due for full service check.",
      });
    }
    ...
    if (aisha) {
      equipmentData.push({
        ...
        vendorName: "HaloLight Direct",
        maintenanceNotes:
          "Currently in for printer calibration. Expected return in 5 days.",
      });
    }
    ...
    if (tom) {
      equipmentData.push({
        ...
        vendorName: "HaloLight Reseller",
        maintenanceNotes:
          "Warranty expired. Recommend discussing extended service plan or upgrade path.",
      });
    }
      ...
      equipmentData.push(
        {
          ...
          vendorName: "HaloLight Direct",
          maintenanceNotes:
            "New install. All systems nominal. Full 360 rotation tested.",
        },
        {
          userId: priya.id,
          productModel: "HaloLight Pro 2",
    ...
    for (const eq_ of insertedEquipment) {
      ...
      if (eq_.serial === "HLE-2024-001") {
        histories.push(
          {
            equipmentId: eq_.id,
            serviceDate: monthsAgo(14),
            serviceType: "inspection",
            description: "Initial setup and calibration. All systems verified.",
            technicianName: "Alex R.",
            cost: "0.00",
            nextServiceDate: monthsAgo(8),
          },
          {
            equipmentId: eq_.id,
            ...
            description:
              "6-month service: printer head clean, belt tension checked, exterior polished.",
            technicianName: "Alex R.",
            cost: "149.00",
            nextServiceDate: monthsAgo(2),
          },
          {
            equipmentId: eq_.id,
            ...
            serviceType: "routine_maintenance",
            description:
              "6-month service complete. Replaced feed rollers, updated firmware to v4.2.1.",
            technicianName: "Jamie K.",
            cost: "179.00",
            nextServiceDate: monthsFromNow(4),
          },
        );
      }
        ...
        histories.push(
          {
            ...
            serviceType: "inspection",
            description:
              "Initial setup inspection. Ring light positioned. Backdrop rail installed.",
            technicianName: "Sam T.",
            cost: "0.00",
            nextServiceDate: monthsAgo(3),
          },
          {
            equipmentId: eq_.id,
            ...
            serviceType: "repair",
            description:
              "Ring light LED strip replaced after partial failure at event. Tested thoroughly.",
            technicianName: "Sam T.",
            cost: "89.00",
            nextServiceDate: monthsFromNow(3),
          },
          {
            equipmentId: eq_.id,
            ...
            serviceType: "routine_maintenance",
            description:
              "Annual maintenance: all lighting tested, iPad holder re-secured, print station aligned.",
            technicianName: "Jamie K.",
            cost: "129.00",
            nextServiceDate: monthsFromNow(5),
          },
        );
      }
      ...
      if (eq_.serial === "HL2-2023-101") {
        histories.push(
          {
            equipmentId: eq_.id,
            serviceDate: monthsAgo(22),
            serviceType: "inspection",
            description:
              "Initial inspection on delivery. Minor transit scuff noted on base plate.",
            technicianName: "Alex R.",
            cost: "0.00",
            nextServiceDate: monthsAgo(16),
          },
          {
            equipmentId: eq_.id,
            serviceDate: monthsAgo(16),
            serviceType: "routine_maintenance",
            description:
              "6-month service. Print head cleaned, firmware v3.9.0 installed.",
            technicianName: "Alex R.",
            cost: "149.00",
            nextServiceDate: monthsAgo(10),
          },
          {
            equipmentId: eq_.id,
            serviceDate: monthsAgo(10),
            serviceType: "routine_maintenance",
            description:
              "12-month full service. Replaced cutter blade, cleaned all rollers. Warranty check completed.",
            technicianName: "Jamie K.",
            cost: "229.00",
            nextServiceDate: monthsAgo(4),
          },
          {
            equipmentId: eq_.id,
            serviceDate: monthsAgo(5),
            serviceType: "repair",
            description:
              "Jam sensor malfunction at event. Sensor replaced. Unit returned same day.",
            technicianName: "Emergency Tech",
            cost: "199.00",
            nextServiceDate: monthsAgo(1),
          },
        );
      }
      ...
      if (eq_.serial === "HL2-2024-205") {
        histories.push(
          {
            equipmentId: eq_.id,
            serviceDate: monthsAgo(12),
            serviceType: "inspection",
            description: "Initial setup. Everything operational.",
            technicianName: "Sam T.",
            cost: "0.00",
            nextServiceDate: monthsAgo(6),
          },
          {
            equipmentId: eq_.id,
            ...
            serviceType: "routine_maintenance",
            description:
              "6-month service completed. Print head, rollers, and sensors all passed.",
            technicianName: "Sam T.",
            cost: "149.00",
            nextServiceDate: monthsAgo(0),
          },
          {
            equipmentId: eq_.id,
            serviceDate: seedDaysAgo(0),
            serviceType: "repair",
            description:
              "In for printer calibration. Colour drift detected at last event. Estimated 5 days.",
            technicianName: "Jamie K.",
            cost: "95.00",
            nextServiceDate: monthsFromNow(1),
          },
        );
      }
      ...
      if (eq_.serial === "HLOA-2022-088") {
        histories.push(
          {
            equipmentId: eq_.id,
            serviceDate: monthsAgo(34),
            serviceType: "inspection",
            description: "Initial setup.",
            technicianName: "Alex R.",
            cost: "0.00",
            nextServiceDate: monthsAgo(28),
          },
          {
            equipmentId: eq_.id,
            serviceDate: monthsAgo(28),
            serviceType: "routine_maintenance",
            description: "6-month service.",
            technicianName: "Alex R.",
            cost: "149.00",
            nextServiceDate: monthsAgo(22),
          },
          {
            equipmentId: eq_.id,
            serviceDate: monthsAgo(22),
            serviceType: "routine_maintenance",
            description:
              "12-month service. Updated firmware, replaced paper rollers.",
            technicianName: "Jamie K.",
            cost: "229.00",
            nextServiceDate: monthsAgo(16),
          },
          ...
          {
            equipmentId: eq_.id,
            serviceDate: monthsAgo(11),
            serviceType: "warranty_claim",
            description: "Touch screen replaced under warranty before expiry.",
            technicianName: "Alex R.",
            cost: "0.00",
            nextServiceDate: monthsAgo(5),
          },
        );
      }
      ...
      if (eq_.serial === "HLS360-2024-301") {
        histories.push(
          {
            equipmentId: eq_.id,
            serviceDate: monthsAgo(7),
            serviceType: "inspection",
            description:
              "Full 360 platform commissioned. Motor, rotation tracking, and printer all calibrated.",
            technicianName: "Jamie K.",
            cost: "0.00",
            nextServiceDate: monthsAgo(1),
          },
          {
            ...
            serviceType: "routine_maintenance",
            description:
              "6-month service. Rotation motor lubricated, firmware v2.1.0 installed. All clear.",
            technicianName: "Jamie K.",
            cost: "199.00",
            nextServiceDate: monthsFromNow(5),
          },
  ...
  if (existingStock.length > 0) {
    ...
    const daysAgo = seedDaysAgo;

    if (sarah && paper4x6Glossy && ribbonDS40 && cleaningKit && propsBox) {
      stockData.push(
        {
          userId: sarah.id,
          catalogItemId: paper4x6Glossy.id,
          currentQuantity: 8,
          estimatedDailyUsage: "0.6",
          lastRestockedAt: daysAgo(14),
          lowStockAlertEnabled: true,
        },
        {
          userId: sarah.id,
          catalogItemId: paper4x6Matte!.id,
          currentQuantity: 5,
          estimatedDailyUsage: "0.3",
          lastRestockedAt: daysAgo(21),
          lowStockAlertEnabled: true,
        },
        {
          userId: sarah.id,
          catalogItemId: ribbonDS40.id,
          currentQuantity: 6,
          estimatedDailyUsage: "0.5",
          lastRestockedAt: daysAgo(10),
          lowStockAlertEnabled: true,
        },
        {
          userId: sarah.id,
          catalogItemId: cleaningKit.id,
          currentQuantity: 3,
          estimatedDailyUsage: "0.1",
          lastRestockedAt: daysAgo(60),
          lowStockAlertEnabled: true,
        },
        {
          userId: sarah.id,
          catalogItemId: propsBox.id,
          currentQuantity: 2,
          estimatedDailyUsage: "0.05",
          lastRestockedAt: daysAgo(90),
      ...
      stockData.push(
        {
          ...
          catalogItemId: paper4x6Glossy.id,
          currentQuantity: 2,
          estimatedDailyUsage: "0.7",
          lastRestockedAt: daysAgo(30),
          lowStockAlertEnabled: true,
        }, // LOW
        {
          userId: marcus.id,
          catalogItemId: paper2x6Strip!.id,
          currentQuantity: 3,
          estimatedDailyUsage: "0.5",
      ...
      stockData.push(
        {
          ...
          catalogItemId: paper4x6Glossy.id,
          currentQuantity: 10,
          estimatedDailyUsage: "0.8",
          lastRestockedAt: daysAgo(7),
          lowStockAlertEnabled: true,
        },
        {
          userId: priya.id,
          catalogItemId: ribbonDS620.id,
          currentQuantity: 5,
          estimatedDailyUsage: "0.7",
          lastRestockedAt: daysAgo(12),
          lowStockAlertEnabled: true,
        },
        {
          userId: priya.id,
    ...
    if (marcus && paper4x6Glossy && ribbonDS40) {
      orderData.push(
        ...
        },
        {
          ...
          orderedAt: dDate(3),
          deliveredAt: null,
          notes: "Rush order — running critically low",
        },
      );
    }
