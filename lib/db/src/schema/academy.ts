...
export const courses = pgTable(
  ...
  (t) => [index("courses_published_order_idx").on(t.isPublished, t.order)],
);
...
export const courseModules = pgTable(
  ...
  (t) => [index("course_modules_course_order_idx").on(t.courseId, t.order)],
);
...
export const lessons = pgTable(
  ...
  (t) => [index("lessons_module_published_order_idx").on(t.moduleId, t.isPublished, t.order)],
);
...
export const quizQuestions = pgTable(
  ...
  (t) => [index("quiz_questions_lesson_order_idx").on(t.lessonId, t.order)],
);
...
export const userLessonProgress = pgTable(
  ...
  (t) => [
    ...
    index("user_lesson_progress_user_completed_idx").on(
      t.userId,
      t.completedAt,
    ),
  ],
