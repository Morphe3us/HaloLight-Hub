...
export const contracts = pgTable(
  "contracts",
  {
    ...
    responsibilityTerms: text("responsibility_terms"),
    breakdownTerms: text("breakdown_terms"),
    postponementTerms: text("postponement_terms"),
    forceMajeureTerms: text("force_majeure_terms"),
    privacyTerms: text("privacy_terms"),
